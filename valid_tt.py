...
def execute_valid(args, total_data, model,
                  ...
                  s_history, o_history,
                  s_label, o_label,
                  s_frequency, o_frequency, static_graph, t_graph):
    s_ranks2 = []
    o_ranks2 = []
    all_ranks2 = []
    ...
    for batch_data in utils.make_batch(data,
        ...
        with torch.no_grad():
            ...
            sub_rank3, obj_rank3, cur_loss3, ce_all_acc = model(batch_data, 'Valid', static_graph, t_graph, total_data)
...
def execute_valid_oracle(args, total_data, model,
                  data,
                  s_history, o_history,
                  s_label, o_label,
                  s_frequency, o_frequency, static_graph, t_graph):
    ...
    for batch_data in utils.make_batch(data,
        ...
        with torch.no_grad():
            sub_rank1, obj_rank1, _, \
            _, _, _, \
            _, _, _, ce_all_acc = model(batch_data, 'Valid', static_graph, t_graph, total_data)
